...
public class CriarJogoRequestTests
{
    [Fact]
    ...
    public void DevePreservarADataJaEmUtc()
    {
        ...
        var request = new CriarJogoRequest("Celeste", 75m, DataLancamento: utc);
    ...
    public void DeveConverterADataLocalParaOInstanteEquivalenteEmUtc()
    {
        ...
        var request = new CriarJogoRequest("Celeste", 75m, DataLancamento: local);
    ...
    {
        CriarJogoRequest request = new CriarJogoRequest("Celeste", 75m) with
        {
            DataLancamento = new DateTime(2024, 1, 15, 0, 0, 0, DateTimeKind.Unspecified),
        };
    ...
    {
        var request = new CriarJogoRequest("Celeste", 75m);
